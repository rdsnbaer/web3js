...
var web3 = new Web3('http://127.0.0.1:8087')
...
// curl -X POST --data '{"jsonrpc":"2.0","method":"brc_getSuccessPendingOrderForAddr","params":["0x41ff923c81d7a47f262f9fca7359014cdc19c7f7", "1562312503000", "1562312603000", "50", "-1"],"id":1}' http://39.104.206.147:8087


web3.eth.getSuccessPendingOrderForAddr("0x41ff923c81d7a47f262f9fca7359014cdc19c7f7", "1562312503000", "1562312603000", "30").then(function(result) {
	console.log(" ******************************** 查询订单 ***********************************************")
	console.log("address 0x41ff923c81d7a47f262f9fca7359014cdc19c7f7 info:", result)
})
