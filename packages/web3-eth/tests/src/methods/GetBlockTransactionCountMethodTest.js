...
describe('GetBlockTransactionCountMethodTest', () => {
    ...
    it('constructor check', () => {
        expect(getBlockTransactionCountMethod.rpcMethod).toEqual('brc_getBlockTransactionCountByNumber');
    });
    ...
    it('calls execute with hash', () => {
        ...
        expect(getBlockTransactionCountMethod.rpcMethod).toEqual('brc_getBlockTransactionCountByHash');
    });
