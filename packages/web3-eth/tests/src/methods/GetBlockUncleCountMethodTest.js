...
describe('GetBlockUncleCountMethodTest', () => {
    ...
    it('constructor check', () => {
        expect(getBlockUncleCountMethod.rpcMethod).toEqual('brc_getUncleCountByBlockNumber');
    });
    ...
    it('calls execute with hash', () => {
        ...
        expect(getBlockUncleCountMethod.rpcMethod).toEqual('brc_getUncleCountByBlockHash');
    });
