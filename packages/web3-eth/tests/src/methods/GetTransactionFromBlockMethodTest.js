...
describe('GetTransactionFromBlockMethodTest', () => {
    ...
    it('constructor check', () => {
        expect(getTransactionFromBlockMethod.rpcMethod).toEqual('brc_getTransactionByBlockNumberAndIndex');
    });
    ...
    it('calls execute with hash', () => {
        ...
        expect(getTransactionFromBlockMethod.rpcMethod).toEqual('brc_getTransactionByBlockHashAndIndex');
    });
