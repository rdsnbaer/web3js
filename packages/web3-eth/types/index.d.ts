...
export class Eth extends AbstractWeb3Module {
	...
	getPendingOrderPoolForAddr(address: string, address: string): Promise<string>;
    getPendingOrderPoolForAddr(address: string, address: string, defaultBlock: string | number): Promise<string>;
    getPendingOrderPoolForAddr(address: string, address: string, callback?: (error: Error, balance: string) => void): Promise<string>;
    getPendingOrderPoolForAddr(address: string, address: string, defaultBlock: string | number, callback?: (error: Error, balance: string) => void): Promise<string>;
	
	getPendingOrderPool(address: string, address: string, address: string): Promise<string>;
    getPendingOrderPool(address: string, address: string, address: string, defaultBlock: string | number): Promise<string>;
    getPendingOrderPool(address: string, address: string, address: string, callback?: (error: Error, balance: string) => void): Promise<string>;
    getPendingOrderPool(address: string, address: string, address: string, defaultBlock: string | number, callback?: (error: Error, balance: string) => void): Promise<string>;

    getSuccessPendingOrderMethod(address: string): Promise<string>;
