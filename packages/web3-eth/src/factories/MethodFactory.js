...
import {
    ...
    EstimateGasMethod,
    GetBalanceMethod,
	GetPendingOrderPoolForAddrMethod,
	GetPendingOrderPoolMethod,
    GetSuccessPendingOrderMethod,
	GetSuccessPendingOrderForAddrMethod,
...
export default class MethodFactory extends AbstractMethodFactory {
    ...
    constructor(utils, formatters) {
        ...
        this.methods = {
			...
			getPendingOrderPoolForAddr: GetPendingOrderPoolForAddrMethod,
			getPendingOrderPool: GetPendingOrderPoolMethod,
            getSuccessPendingOrder: GetSuccessPendingOrderMethod,
			getSuccessPendingOrderForAddr: GetSuccessPendingOrderForAddrMethod,
