...
export default class EthSendTransactionMethod extends SendTransactionMethod {
    ...
    beforeExecution(moduleInstance) {
         console.log("beforeExecution-------brc_sendRawTransaction")
        if (this.rpcMethod !== 'brc_sendRawTransaction') {
     ...
     */
    execute() {
        console.log("EthSendTransactionMethod-------")
    ...
    async sendRawTransaction(privateKey = null) {
        console.log("xxxxxxxxx      sendRawTransaction")
        ...
        this.rpcMethod = 'brc_sendRawTransaction';
