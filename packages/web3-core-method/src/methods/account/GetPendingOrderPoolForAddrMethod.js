...
*/
/**
 * @file GetPendingOrderPoolForAddrMethod.js
...
export default class GetPendingOrderPoolForAddrMethod extends AbstractMethod {
    /**
     * @param {Utils} utils
    ...
    constructor(utils, formatters, moduleInstance) {
        super('brc_getPendingOrderPoolForAddr', 3, utils, formatters, moduleInstance);
    }
    ...
    afterExecution(response) {
		return response;
        //return this.formatters.outputAddressInfo(response);
    }
}
