...
export default class TransactionObserver {
    ...
    /**
     * Observes the transaction with the newHeads subscriptions which sends the brc_getTransactionReceipt method on each item
     *
    ...
    /**
     * Observes the transaction with sending brc_getTransactionReceipt and checking if there is really a new block
     *
