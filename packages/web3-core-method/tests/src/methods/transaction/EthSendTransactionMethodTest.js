...
describe('EthSendTransactionMethodTest', () => {
    ...
    it('calls execute signs locally but doesnt have chainId defined and returns with a resolved promise', (done) => {
        ...
        method.callback = (error, hash) => {
            ...
            expect(method.rpcMethod).toEqual('brc_sendRawTransaction');
    ...
    it('calls execute and the gasPrice will be defined with "brc_gasPrice" and returns with a resolved promise', (done) => {
    ...
    it('calls execute and the gasPrice will be defined with "brc_gasPrice" and returns with a reject promise', async () => {
        providerMock.send = jest.fn(() => {
        ...
        expect(providerMock.send).toHaveBeenNthCalledWith(1, 'brc_gasPrice', []);
    });
    ...
    it('calls execute and signs on the node', (done) => {
        ...
        method.callback = (error, hash) => {
            ...
            expect(providerMock.send).toHaveBeenCalledWith('brc_sendTransaction', parameters);
