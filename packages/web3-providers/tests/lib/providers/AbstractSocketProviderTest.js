...
describe('AbstractSocketProviderTest', () => {
    ...
    it('calls onConnect and connect event will be emitted', async () => {
        ...
        abstractSocketProvider.subscriptions['0x0'] = {
            id: '0x0',
            subscribeMethod: 'brc_subscribe',
            parameters: ['logs', {}]
        };

        abstractSocketProvider.send = jest.fn((subscribeMethod, parameters) => {
            expect(subscribeMethod).toEqual('brc_subscribe');
    ...
    it('calls unsubscribe and subscription id does not exist', () => {
        expect(abstractSocketProvider.unsubscribe('no', 'brc_unsubscribe')).rejects.toThrow(
    ...
    it('calls unsubscribe and resolves to a promise', async () => {
        ...
        abstractSocketProvider.send = jest.fn((subscribeMethod, parameters) => {
            expect(subscribeMethod).toEqual('brc_unsubscribe');
        ...
        const reaponse = await abstractSocketProvider.unsubscribe('0x0', 'brc_unsubscribe');
    ...
    it('calls clearSubscriptions and one unsubscribe call returns false', async () => {
        ...
        await expect(abstractSocketProvider.clearSubscriptions('brc_unsubscribe')).rejects.toThrow(
    ...
    it('calls clearSubscriptions and all unsubscribe calls are returning true', async () => {
        ...
        const response = await abstractSocketProvider.clearSubscriptions('brc_unsubscribe');
