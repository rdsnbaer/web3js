...
export default class AbstractSocketProvider extends EventEmitter {
     ...
     */
    subscribe(subscribeMethod = 'brc_subscribe', subscriptionMethod, parameters) {
     ...
     */
    unsubscribe(subscriptionId, unsubscribeMethod = 'brc_unsubscribe') {
     ...
     * @returns {Promise<Boolean|Error>}
     */
    clearSubscriptions(unsubscribeMethod = 'brc_unsubscribe') {
